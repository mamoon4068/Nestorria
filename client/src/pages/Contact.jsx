    ...
    <div className='bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28'>
       <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-amber-500 hover:underline">contact@nestorria.com</a>
            </p>
            
            <div className="max-w-96 w-full px-4">
                <label htmlFor="name" className="font-medium">Full Name</label>
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 bg-amber-500/10 rounded-full focus-within:ring-black/80  transition-all overflow-hidden">
                ...
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 bg-amber-500/10 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
                ...
                <button type="submit" className="flex items-center  justify-center gap-1 mt-5 bg-amber-500 hover:bg-amber-600 hover:cursor-pointer text-white py-2.5 w-full rounded-full transition">
                    Submit Form
