...
const  PropertyImages = ({property}) => {
    const [hoveredIndex, setHoveredIndex] = useState(0) //Initially first images is expanded
    const imageCaptions = [
        {
            heading: "Front View",
            desc: "Exprience a stunning first impression with elegant curb appeal",
        },
        {
            heading: "Living Area",
        ...
        },
        {
            ...
            desc: "Full equipped kitchen with sleek finishes and modern appliances.",
        },
    ]
  return (
